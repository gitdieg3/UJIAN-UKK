...
// Ambil daftar kategori dari tabel_katagori
$katagori_list = mysqli_query($conn, "SELECT * FROM tabel_katagori");
...
if (isset($_POST['update'])) {
    ...
    if ($nama_barang && $katagori && $jumlah !== "" && $harga !== "" && $tanggal) {
        if (!is_numeric($jumlah) || !is_numeric($harga) || $jumlah < 0 || $harga < 0) {
            $warning = "Jumlah dan harga harus berupa angka positif.";
        } else {
                    ...
                    <form action="" method="POST">
                            ...
                            <select class="form-select" id="katagori" name="katagori" required>
                                ...
                                <?php while ($row = mysqli_fetch_assoc($katagori_list)) : ?>
                                    <option value="<?php echo htmlspecialchars($row['katagori']); ?>"
                                        <?php echo $katagori == $row['katagori'] ? 'selected' : ''; ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="jumlah" name="jumlah"
                                value="<?php echo htmlspecialchars($jumlah); ?>" required>
                        </div>
